...
let documentId = url.substring(url.lastIndexOf('=') + 1);  //The Id is in the URL lmao
const socket = new WebSocket('ws://localhost:8000?doc=' + documentId);
let messageTable = {}
...
socket.addEventListener('message', function(event){
    ...
    if(messageTable[messageObject.id] != undefined) //This is a request from us, we ignore it
